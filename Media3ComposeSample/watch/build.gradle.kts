...
android {
    namespace = "io.oliverapps.media3.compose"
    compileSdk {
...
dependencies {
    ...
    implementation(watch.compose.material3)
    implementation(watch.compose.foundation)
    implementation(watch.compose.ui.tooling)
    implementation(watch.wear.tooling.preview)
    implementation(watch.core.splashscreen)
    implementation(watch.wear.input)
